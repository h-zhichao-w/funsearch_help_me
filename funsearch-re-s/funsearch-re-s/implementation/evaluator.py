...
def _convert_to_tuple(lst):
  if isinstance(lst, list):
      return tuple(_convert_to_tuple(item) for item in lst)
  else:
      return lst
    ...
    def analyse(
        ...
        for current_input in self._inputs:
            ...
            if runs_ok and not _calls_ancestor(program, self._function_to_evolve) and test_output is not None:
                ...
                # key_tuple = _convert_to_tuple(current_input)    #* 转换成 hashable 的 tuple
                # scores_per_test[key_tuple] = test_output
