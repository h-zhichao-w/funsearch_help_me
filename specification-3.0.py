...
print(get_start_time('2024/3/5  21:00:00'))
sat_task_selected = main(path='D:\\OneDrive - sjtu.edu.cn\\Bachelor Thesis\\Simulation Data\\Simulation Time-24hr\\', sat_num=sat_num, half_cone_angle=half_cone_angle, constraints=constraints, time_step=time_step, start_time=start_time_24hr)
print(sat_task_selected)
coverage_level = evaluator(path='D:\\OneDrive - sjtu.edu.cn\\Bachelor Thesis\\Simulation Data\\Simulation Time-24hr\\', sat_num=sat_num, half_cone_angle=half_cone_angle, constraints=constraints, time_step=time_step, start_time=start_time_24hr)
